...
cp -v "../buildroot/output/images/bzImage" "isoroot/fb.bzi"
mkisofs -o "FIREBrick-${FB_VERSION}_${BR2_GCC_TARGET_ARCH}.iso" -b isolinux.bin -c isolinux.cat -no-emul-boot -boot-load-size 4 -boot-info-table -V FIREBrick isoroot/
